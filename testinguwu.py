...
def train_butterfly_supersuit(
    env_fn, steps: int = 10_000, seed: int | None = 0, model_name="model", **env_kwargs
):
    ...
    if os.path.exists(model_name):
        ...
        model = PPO.load(
            model_name + "/" + model_name, env=env, device="cpu"
...
if __name__ == "__main__":
    ...
    env_kwargs = {"max_cycles": 5_000}
    model_name = "model_random_direction_only_forward_movement"
    ...
    # Watch 2 games
    eval(env_fn_aec, num_games=2, render_mode="human",model_name=model_name, **env_kwargs)
